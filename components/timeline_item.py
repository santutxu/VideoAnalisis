...
class TimelineItem2(QGraphicsRectItem):
    """Item del timeline con capacidad de selección parcial"""
    ...
    def __init__(self, video_path, x, y, duration_ms, pixels_per_second=10, start_trim=0, end_trim=None):
        ...
        self.end_trim = end_trim if end_trim is not None else duration_ms
